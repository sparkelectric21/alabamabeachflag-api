...
const captionPage = `<div class="graphicast"><div class="image"><img src="https://www.weather.gov/images/mob/graphicast/6.png" style="max-width: 100%;"></div><div class="description">5-Day Rip Current Outlook for Coastal Alabama and Northwest Florida. For more information, go to <a href="https://www.weather.gov/beach/mob">weather.gov/beach/mob</a>.</div></div>`;
...
describe("NWS rip current refresh", () => {
	it("narrowly discovers the labeled official image", () => { expect(discoverRipCurrentImage(page).href).toBe("https://www.weather.gov/images/mob/graphicast/6.png"); expect(discoverRipCurrentImage(captionPage).href).toBe("https://www.weather.gov/images/mob/graphicast/6.png"); expect(() => discoverRipCurrentImage(`<div class="graphicast"><div class="image"><img src="https://example.com/x.png"></div><div class="description">5-Day Rip Current Outlook for Coastal Alabama and Northwest Florida</div></div>`)).toThrow(); });
