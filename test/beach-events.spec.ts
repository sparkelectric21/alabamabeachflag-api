...
describe("exact beach event matching", () => {
	...
	it("matches Tier One exact locations and explains strict exclusions", () => {
		...
		expect(exactBeachMatch({ providerId: "gulfStatePark", venue: "Gulf State Park Pavillion", address: "22250 E Beach Blvd, Gulf Shores, AL 36542, USA" })).toEqual({ beachId: "gulf-state-park-pavilion", method: "sourceAlias" });
