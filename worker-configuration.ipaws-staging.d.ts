/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ipaws.staging.jsonc worker-configuration.ipaws-staging.d.ts` (hash: 8bbd2372fd7184741e8c3e6c68c3a019)
// Runtime types generated with workerd@1.20260921.1 2026-06-27 nodejs_compat
interface __BaseEnv_Env {
	BEACH_DATA: KVNamespace;
	IPAWS_INGESTION_ENABLED: "true";
	IPAWS_ENVIRONMENT: "staging";
	IPAWS_ALLOWED_TOPIC_ARNS: "arn:aws-us-gov:sns:us-gov-west-1:594897668655:EAS_PUBLIC_FEED";
	...
	IPAWS_SNS_MAX_AGE_SECONDS: "3600";
	IPAWS_SNS_MAX_FUTURE_SKEW_SECONDS: "300";
	IPAWS_IDEMPOTENCY: DurableObjectNamespace<import("./src/ipaws/worker").IpawsIdempotencyCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/ipaws/worker");
		durableNamespaces: "IpawsIdempotencyCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IPAWS_INGESTION_ENABLED" | "IPAWS_ENVIRONMENT" | "IPAWS_ALLOWED_TOPIC_ARNS" | "IPAWS_AUTO_CONFIRM_SUBSCRIPTION" | "IPAWS_HEALTH_TTL_SECONDS" | "IPAWS_RECORD_TTL_SECONDS" | "IPAWS_SUBSCRIPTION_TTL_SECONDS" | "IPAWS_PARSE_BYTE_LIMIT" | "IPAWS_SNS_MAX_AGE_SECONDS" | "IPAWS_SNS_MAX_FUTURE_SKEW_SECONDS">> {}
}
