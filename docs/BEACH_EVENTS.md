...
| Town of Dauphin Island | Official page with an embedded third-party calendar | Town of Dauphin Island | Manual | Manual-only | The discovered AddEvent calendar identifies itself as Alabama Audubon rather than a verified Town-owned feed. Do not automate until ownership is clarified. |
