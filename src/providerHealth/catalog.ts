...
const defaults: ProviderCatalogRecord[] = [
	...
	{ provider: "ndbc", domain: "water_temperature:PPTA1", displayName: "NOAA NDBC PPTA1 · Perdido Pass", category: "Water Temperature", role: "Primary", description: "Direct inlet observation at Perdido Pass.", usedFor: ["Orange Beach water temperature"], productionUsage: "Active when fresh.", internalNotes: "Fresh 90 min; unavailable after 180 min.", officialSource: true, websiteVisible: true, editable: true },
	{ provider: "ndbc", domain: "water_temperature:DPHA1", displayName: "NOAA NDBC DPHA1 · Dauphin Island", category: "Water Temperature", role: "Secondary", description: "Direct observation near the Mobile Bay entrance.", usedFor: ["Fort Morgan fallback"], productionUsage: "Active when fresh and plausible.", internalNotes: "Fresh 90 min; unavailable after 180 min.", officialSource: true, websiteVisible: true, editable: true },
	{ provider: "ndbc", domain: "water_temperature:42012", displayName: "NOAA NDBC Buoy 42012", category: "Water Temperature", role: "Automatic Fallback", description: "Direct offshore northern Gulf observation.", usedFor: ["Gulf Shores", "Orange Beach fallback", "Fort Morgan fallback"], productionUsage: "Active when fresh.", internalNotes: "Fresh 60 min; unavailable after 180 min.", officialSource: true, websiteVisible: true, editable: true },
	{ provider: "ndbc", domain: "water_temperature:42357", displayName: "DISL/NDBC Sofar 42357", category: "Water Temperature", role: "Primary", description: "Direct nearshore observation south of Dauphin Island.", usedFor: ["Fort Morgan water temperature"], productionUsage: "Active when the NDBC feed reports valid WTMP.", internalNotes: "Fresh 120 min; unavailable after 240 min.", officialSource: true, websiteVisible: true, editable: true },
	...
	{ provider: "beach_activity_notifications", domain: "beach_events", displayName: "Beach Activity Review Notifications", category: "System", role: "Internal Protection", description: "Delivers change-based and morning review-queue summaries through the existing application email binding.", usedFor: ["Pending Review workflow", "Daily review reminder"], productionUsage: "Active when preferences and Operational Control allow delivery.", internalNotes: "Duplicate suppression uses the pending queue revision and Central calendar day.", officialSource: false, websiteVisible: true, editable: false },
	...
	{ provider: "dauphinIslandTown", domain: "beach_events", displayName: "Town of Dauphin Island Events", category: "Beach Events", role: "Primary", description: "Discovers the newest official monthly Town Crier PDF and extracts conservative factual event candidates.", usedFor: ["Exact-beach Dauphin Island event discovery", "Pending Review workflow"], productionUsage: "Enabled; Town Crier is the sole active source while embedded-calendar access is unapproved.", internalNotes: "Never request the embedded calendar. Preserve last-good facts after archive, PDF, or conversion failures. Never infer a beach from Dauphin Island alone.", officialSource: true, websiteVisible: true, editable: true, sourceType: "PDF Newsletter", authority: "Town of Dauphin Island", refreshCadence: "Daily at 7:00 AM Central", attributionNeeds: "Display the Town Crier issue month, official PDF link, and newsletter-change note.", legalUsageNotes: "Official Town archive and PDF; retain limited factual metadata and independently written presentation text.", sourceURL: "https://www.townofdauphinisland.org/newsletters", publicFeed: true, automatedRetrieval: "Intended", cachingPolicy: "Last successful normalized facts; no newsletter images or full articles", coverageArea: "Dauphin Island", supportedBeachMappings: ["dauphin-island-public-beach", "dauphin-island-east-end"], knownLimitations: "Image-based PDFs require document conversion. West End Beach is not represented by a current backend/iOS beach ID and remains excluded with reason: Exact beach not represented in app. The embedded calendar remains deferred pending written permission." },
