...
const defaults: ProviderCatalogRecord[] = [
	...
	{ provider: "gulfShoresCity", domain: "beach_events", displayName: "City of Gulf Shores Special Events", category: "Beach Events", role: "Primary", description: "Official structured Special Events calendar; only exact approved beach venues are retained.", usedFor: ["Beach Activity & Event Impact"], productionUsage: "Enabled for discovery and review.", internalNotes: "No citywide inference. Venue matching is exact.", officialSource: true, websiteVisible: true, editable: true, sourceType: "iCalendar", authority: "City of Gulf Shores", refreshCadence: "Every 6 hours", attributionNeeds: "Display source name and official event URL.", legalUsageNotes: "Official public subscription feed; store normalized facts only." },
	{ provider: "orangeBeachParks", domain: "beach_events", displayName: "City of Orange Beach Parks and Recreation", category: "Beach Events", role: "Primary", description: "Official structured Parks and Recreation calendar; inland and citywide entries are rejected.", usedFor: ["Beach Activity & Event Impact"], productionUsage: "Enabled for discovery and review.", internalNotes: "Exact approved beach venues only.", officialSource: true, websiteVisible: true, editable: true, sourceType: "iCalendar", authority: "City of Orange Beach", refreshCadence: "Every 6 hours", attributionNeeds: "Display source name and official event URL.", legalUsageNotes: "Official public subscription feed; store normalized facts only." },
	{ provider: "gulfStatePark", domain: "beach_events", displayName: "Gulf State Park Activities Calendar", category: "Beach Events", role: "Disabled", description: "Official activities page with an embedded calendar.", usedFor: ["Future beach-specific activities"], productionUsage: "Disabled pending a verified structured feed.", internalNotes: "Do not scrape the embedded calendar.", officialSource: true, websiteVisible: true, editable: true, sourceType: "Embedded calendar", authority: "Alabama State Parks", refreshCadence: "None", attributionNeeds: "State park attribution required if enabled.", legalUsageNotes: "Technically brittle without a verified public feed." },
