...
const defaults: ProviderCatalogRecord[] = [
	...
	{ provider: "dauphinIslandTown", domain: "beach_events", displayName: "Town of Dauphin Island Events", category: "Beach Events", role: "Disabled", description: "Official Town page directly embeds a public Events Calendar JSON project, but vendor terms prohibit automated retrieval without written permission.", usedFor: ["Manual beach-event discovery and assignment"], productionUsage: "Disabled; manual creation fallback only.", internalNotes: "Never fetch the embedded endpoint automatically or infer a beach from Dauphin Island alone. Events Calendar project: proj_Uup5Kfrh1ITrNrHIMFrvw.", officialSource: true, websiteVisible: true, editable: true, sourceType: "Embedded third-party JSON", authority: "Town of Dauphin Island calendar publisher; Events Calendar infrastructure", refreshCadence: "None while permission is absent", attributionNeeds: "For manual records, display Town of Dauphin Island and link to the official Town calendar or event page.", legalUsageNotes: "Events Calendar Terms of Use (last updated 2023-02-07) prohibit automated/non-human access, systematic retrieval, and scrapers. Written permission is required before enabling.", sourceURL: "https://www.townofdauphinisland.org/calendar-of-events", publicFeed: true, automatedRetrieval: "Prohibited absent written permission", coverageArea: "Dauphin Island", supportedBeachMappings: ["dauphin-island-public-beach", "dauphin-island-east-end"], knownLimitations: "West End Beach is not represented by a current backend/iOS beach ID and must remain excluded with reason: Exact beach not represented in app." },
